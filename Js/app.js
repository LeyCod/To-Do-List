...
const handlerClick = (event) => {
    ...
    <li id="taskText">${newTask.value} <button id="dltBtn" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
